...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 298.200005769729614, 364.800005435943604, 150.0, 20.0 ],
					"text" : "~120ms delay"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 924.000013768672943, 256.800003826618195, 150.0, 20.0 ],
					"text" : "~160ms delay"
				}
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 674.100010216236115, 240.800003588199615, 42.0, 22.0 ],
					"text" : "t b b b"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "signal" ],
					"patching_rect" : [ 702.400010466575623, 336.80000501871109, 63.0, 22.0 ],
					"text" : ">~ 0.0005"
				}
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 831.200019657611847, 289.333342552185059, 72.000000238418579, 22.0 ],
					"sig" : 0.0
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "float", "" ],
					"patching_rect" : [ 670.400009989738464, 478.400007128715515, 35.0, 22.0 ],
					"text" : "timer"
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "bang" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 670.400009989738464, 437.600006520748138, 24.0, 24.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "bang" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 708.000010550022125, 437.600006520748138, 24.0, 24.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "bang" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 764.000011384487152, 368.000005483627319, 24.0, 24.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 702.400010466575623, 399.333343386650085, 55.0, 22.0 ],
					"text" : "onebang"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "bang", "bang" ],
					"patching_rect" : [ 702.400010466575623, 364.800005435943604, 42.0, 22.0 ],
					"text" : "edge~"
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "bang" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 685.600010216236115, 300.000004470348358, 24.0, 24.0 ]
				}
...
, 							{
								"box" : 								{
									...
									"outlettype" : [ "", "bang" ],
									"parameter_enable" : 0,
									"patching_rect" : [ 129.299991607666016, 100.0, 50.0, 22.0 ]
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 129.299991607666016, 129.199999809265137, 58.0, 22.0 ],
									"text" : "speed $1"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 2,
									"outlettype" : [ "signal", "signal" ],
									"patching_rect" : [ 50.0, 170.400000809265293, 190.0, 35.0 ],
...
,
					"patching_rect" : [ 582.400008678436279, 258.666673362255096, 39.0, 22.0 ],
					"saved_object_attributes" : 					{
						"description" : "",
						"digest" : "",
						"globalpatchername" : "",
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "bang" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 674.100010216236115, 206.933332622051239, 24.0, 24.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 2,
					"numoutlets" : 0,
					"patching_rect" : [ 773.000012338161469, 277.833342552185059, 45.0, 45.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "signal" ],
					"patching_rect" : [ 505.000015497207642, 154.000004589557648, 40.0, 22.0 ],
					"text" : "*~ 0.2"
				}
				...
				"box" : 				{
					...
					"data" : 					{
						"clips" : [ 							{
								...
								"filekind" : "audiofile",
								"id" : "u044027889",
								"selection" : [ 0.212903225806452, 0.0 ],
								"loop" : 1,
								"content_state" : 								{
									"loop" : 1
								}
...
,
					...
					"parameter_enable" : 0,
					"patching_rect" : [ 806.666692495346069, 57.000000357627869, 210.666668474674225, 53.333334028720856 ],
					"pitchcorrection" : 0,
					"quality" : "basic",
					"timestretch" : [ 0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 4,
					"outlettype" : [ "signal", "signal", "list", "list" ],
					"patching_rect" : [ 343.666682720184326, 258.666673362255096, 71.0, 22.0 ],
					"text" : "omx.comp~"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 2,
					"numoutlets" : 0,
					"patching_rect" : [ 576.000017166137695, 138.333332777023315, 45.0, 45.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "signal", "signal" ],
					"patching_rect" : [ 343.666682720184326, 228.000005781650543, 35.0, 22.0 ],
					"text" : "adc~"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 726.66669225692749, 47.666679739952087, 42.0, 22.0 ],
					"text" : "reload"
				}
...
,
					...
					"outlettype" : [ "signal", "signal", "signal", "", "dictionary" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 505.000015497207642, 23.666664183139801, 150.0, 30.0 ],
					"pitchcorrection" : 0,
					"quality" : "basic",
					"timestretch" : [ 0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "signal" ],
					"patching_rect" : [ 756.797824010145632, 217.333332777023315, 187.0, 22.0 ],
...
, 			{
				"box" : 				{
					...
					"numinlets" : 2,
					"numoutlets" : 0,
					"patching_rect" : [ 219.000012338161469, 398.333334445953369, 45.0, 45.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 756.797824010145632, 138.333332777023315, 187.0, 22.0 ],
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 585.797824010145632, 84.333332777023315, 150.0, 22.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 46.000011999999998, 258.666673362255096, 150.0, 22.0 ]
				}
...
, 			{
				"name" : "e.mp3",
				"bootpath" : "~/Documents/Max 8/Library/rebetika_fem_noguit",
				"patcherrelativepath" : "../../../Max 8/Library/rebetika_fem_noguit",
				"type" : "Mp3",
				"implicit" : 1
			}
, 			{
