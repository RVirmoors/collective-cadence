...
,
		...
		"boxes" : [ 			{
				"box" : 				{
					...
					"outlettype" : [ "" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 338.0, 810.0, 150.0, 22.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 338.0, 810.0, 20.0, 140.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 566.0, 676.0, 280.0, 35.0 ],
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 470.0, 814.0, 98.0, 50.0 ],
					"sync" : 1
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "bang" ],
					"patching_rect" : [ 190.0, 289.0, 58.0, 22.0 ],
					"text" : "loadbang"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 190.0, 317.0, 41.0, 22.0 ],
					"text" : "loop 1"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 347.0, 289.0, 29.5, 22.0 ],
					"text" : "27"
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "", "bang" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 453.199998021125793, 282.0, 50.0, 22.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "bang", "" ],
					"patching_rect" : [ 347.0, 258.0000039935112, 47.0, 22.0 ],
					"text" : "sel 167"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 227.0, 790.0, 70.0, 22.0 ],
					"text" : "loadmess 1"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "bang" ],
					"patching_rect" : [ 650.200006186962128, 796.799989521503448, 58.0, 22.0 ],
					"text" : "loadbang"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 650.200006186962128, 336.400005161762238, 117.0, 22.0 ],
					"text" : "scale 100 2000 1 16"
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "", "bang" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 650.200006186962128, 383.600005865097046, 50.0, 22.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 650.200006186962128, 424.400006473064423, 65.0, 22.0 ],
					"text" : "$1, 1 1000"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "", "bang" ],
					"patching_rect" : [ 650.200006186962128, 468.199999988079071, 40.0, 22.0 ],
					"text" : "line 1"
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "", "bang" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 650.200006186962128, 277.20000159740448, 50.0, 22.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "float", "" ],
					"patching_rect" : [ 650.200006186962128, 187.600002944469452, 35.0, 22.0 ],
					"text" : "timer"
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "bang" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 650.200006186962128, 100.599999964237213, 24.0, 24.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 650.200006186962128, 561.200008511543274, 39.0, 22.0 ],
					"text" : "$1 $1"
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "", "bang" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 650.200006186962128, 509.800000607967377, 50.0, 22.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "jit_matrix", "" ],
					"patching_rect" : [ 379.0, 677.200010478496552, 108.0, 22.0 ],
					"text" : "jit.dimop @op max"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "int" ],
					"patching_rect" : [ 453.199998021125793, 253.0000039935112, 29.5, 22.0 ],
					"text" : "- 96"
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "", "" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 433.199998021125793, 214.599999964237213, 39.0, 32.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "int" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 433.199998021125793, 167.599999964237213, 24.0, 24.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "int" ],
					"patching_rect" : [ 433.199998021125793, 134.599999964237213, 29.5, 22.0 ],
					"text" : "*"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "int" ],
					"patching_rect" : [ 500.199998021125793, 100.599999964237213, 46.0, 22.0 ],
					"text" : "<= 122"
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "", "bang" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 412.199998021125793, 33.599999964237213, 50.0, 22.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "int" ],
					"patching_rect" : [ 433.199998021125793, 100.599999964237213, 39.0, 22.0 ],
					"text" : ">= 97"
				}
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 412.199998021125793, 63.599999964237213, 50.5, 22.0 ],
					"text" : "t b i i i"
				}
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 412.199998021125793, 3.599999964237213, 50.5, 22.0 ],
					"text" : "key"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 253.0, 9.599999964237213, 102.0, 87.0 ],
					"text" : "ESC = fullscreen\n\n1280 x 768\n1920 x 840\n\n1280 x 560"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 650.200006186962128, 825.0, 79.0, 22.0 ],
					"text" : "pos -800 400"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 227.0, 852.0, 87.0, 23.0 ],
					"text" : "fullscreen $1"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "bang", "" ],
					"patching_rect" : [ 379.0, 893.0, 61.0, 22.0 ],
					"text" : "jit.window"
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 650.200006186962128, 600.000009058246633, 195.800001502037048, 22.0 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"midpoints" : [ 462.699998021125793, 321.0, 275.099999010562897, 321.0 ],
					"source" : [ "obj-10", 0 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"midpoints" : [ 432.199998021125793, 98.599999964237213, 419.799998164176941, 98.599999964237213, 419.799998164176941, 203.99999988079071, 462.699998021125793, 203.99999988079071 ],
					"source" : [ "obj-19", 1 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"midpoints" : [ 421.699998021125793, 30.000000059604645, 659.700006186962128, 30.000000059604645 ],
					"order" : 0,
					"source" : [ "obj-9", 0 ]
				}
		...
		"dependency_cache" : [ 			{
				...
				"patcherrelativepath" : "../../../../../../Volumes/PascariuE1/CollectiveCadence/Videos show/Rebetiko Moment/Foxtrot Max",
				"type" : "mpg4",
				"implicit" : 1
			}
, 			{
